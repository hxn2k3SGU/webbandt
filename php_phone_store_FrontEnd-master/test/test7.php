...
<link href="csspublic/slide.css" rel="stylesheet" type="text/css">
</head>
...
<body>
	<div class="slide-Show-Container">
		...
		<div class="row">
			...
			<div class="column">
			  <img class="demo cursor" src="../pic/iphoneslide.webp" style="width:100%" onclick="currentSlide(2)" alt="Cinque Terre">
			</div>
			<div class="column">
			  <img class="demo cursor" src="../pic/iphoneslide.webp" style="width:100%" onclick="currentSlide(3)" alt="Mountains and fjords">
			</div>
			<div class="column">
			  <img class="demo cursor" src="../pic/iphoneslide.webp" style="width:100%" onclick="currentSlide(4)" alt="Northern Lights">
			</div>
			<div class="column">
			  <img class="demo cursor" src="../pic/iphoneslide.webp" style="width:100%" onclick="currentSlide(5)" alt="Northern Lights">
			</div>
			<div class="column">
			  <img class="demo cursor" src="../pic/iphoneslide.webp" style="width:100%" onclick="currentSlide(6)" alt="Northern Lights">
			</div>
  		</div>
	</div>
	<script>
